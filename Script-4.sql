...
select * from roles_employee join roles_1 on roles_employee.role_id = roles_1.id 
...
select * from roles_employee join roles_1 on roles_employee.role_id = roles_1.id 
join employees_1 on roles_employee.employee_id = employees_1.id where role_name like 'Automation%';

--12. Вывести имена и зарплаты Junior специалистов

select * from roles_employee  join employees_1 on roles_employee.employee_id = employees_1.id 
